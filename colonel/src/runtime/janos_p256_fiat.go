...
// crypto/internal/fips140/nistec/fiat/p256_fiat64.go apart from the
// package clause and this header block.  The upstream code is
// auto-generated by the fiat-crypto tool (see the top-of-file
// NOTE) from a formally-verified specification of Montgomery
// arithmetic modulo the P-256 prime p₂₅₆ = 2^256 - 2^224 + 2^192 +
// 2^96 - 1.  The runtime uses these primitives for schedinit-time
// ECDSA verification of the JANOSCRT slot's Release entry.
