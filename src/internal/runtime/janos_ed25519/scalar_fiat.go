...
//
// This file is unmodified from crypto/internal/fips140/edwards25519/
// scalar_fiat.go apart from the package clause and this header block.
// The upstream code is auto-generated by the fiat-crypto tool (see
// the top-of-file NOTE) from a formally-verified specification of
// Montgomery arithmetic modulo the edwards25519 group order.
